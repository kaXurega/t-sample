...
import { HomeIcon, DashboradIcon, MyPageIcon, PredictIcon, ContactIcon, LogoutIcon } from './icons';

const menuItems = [
  { id: 1, label: 'Home', icon: HomeIcon, link: '/home' },
  { id: 2, label: 'MyPage', icon: MyPageIcon, link: '/myPage' },
  { id: 3, label: 'Dashboard', icon: DashboradIcon, link: '/dashboard' },
...
const Sidebar = () => {
  ...
  const collapseIconClasses = classNames('p-4 rounded bg-light-lighter absolute right-0 transform -rotate-90', {
    'transform -rotate-180': toggleCollapse,
  });
        ...
        <div className="flex items-center justify-between relative">
          {/* {isCollapsible && (
            <button className={collapseIconClasses} onClick={handleSidebarToggle}>
              <Image src="/icons/CollapsIcon.svg" alt="collaps" width="16" height="16" />
            </button>
          )} */}
